    ...
    <div className="container-fluid login_page">
      <div className="container py-5 d-md-flex justify-content-between login_container">
        ...
        <div className="sideNote2 container col-12 col-md-6 ms-md-2  mt-sm-5">
          ...
          <h1>ALX Forum Q&A</h1>
          <p>The aim of this platform to support the vision of ALX by understanding "Digital Transformation is the next Industrial Revolution"</p>
          <p>Have planned to create a convinent place where ALX students can ask IT related questions and get answers for their questions.</p>
          <p>ALX Q&A  platform that allows users to create an account and login to their account. A completed Q&A platform that allows account holders to post questions or answers and review questions or answers posted by other users.</p>
